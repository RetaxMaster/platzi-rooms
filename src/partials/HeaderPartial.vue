        ...
        <div class="flex items-center w-auto">
          <div class="items__controls">
            <div class="flex" v-if="user">
              ...
              <router-link :to="{ name: 'CreateHousePage' }" class="no-underline text-grey-darkest mr-2 flex items-center">
              ...
              <button @click.prevent="logOut" class="flex items-center"><i class="material-icons">exit_to_app</i></button>
